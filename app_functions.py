...
def get_search_results(queries_json):
    """
    Params:
...
def generate_learning_outcomes(course_details, total_search_results, citation_style='APA'):
    """
    Params:
...
def generate_course_outline(course_details, learning_outcomes, number_of_topics=5, total_hours=54, weekly_hours=3):
